...
from agentic_system.clients.census import CensusClient
from agentic_system.clients.worldpop import (
    WorldPopClient,
    clamp_worldpop_year,
    make_circle_geojson_featurecollection,
)
from agentic_system.core.context import ExecutionContext
from agentic_system.schemas import DemographicsSummary
from agentic_system.utils.geo import circle_area_km2
