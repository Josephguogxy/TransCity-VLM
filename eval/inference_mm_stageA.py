...
class ModelArguments:
    ...
    # ---- multimodal structure (Stage-A typical defaults) ----
    num_chunk_tokens: int = 4
    adapter_heads: int = 4
    encoder_max_length: int = 512

    # Stage-A often uses a larger image token budget / larger resolution
    ...
    padding_token: Optional[str] = field(
        ...
        metadata={
            "help": (
                "If tokenizer has no pad_token, try to set pad_token to this EXISTING token. "
